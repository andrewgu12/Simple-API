#!/bin/sh -e
# Credits to https://github.com/jackdb/pg-app-dev-vm, with a couple modifications for my setup

# Edit the following to change the name of the database user that will be created:
# NOTE: do not expose password plainly like this! purely for sample sake
APP_DB_USER=simpleapi
APP_DB_PASS=apipass
...
sudo apt update
sudo apt -y install "postgresql-$PG_VERSION" "postgresql-contrib-$PG_VERSION" "postgresql-client-$PG_VERSION" postgresql-client-common libpq-dev
